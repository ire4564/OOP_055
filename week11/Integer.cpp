...
Number *Integer::add(Number * num) {
   ...
   if(num->types() == INTEGER){
        ...
        set_val(number->val() + this->val());
		delete num;
		return this;		
	}
	else if(num->types() == FLOAT){
		Float* number = dynamic_cast<Float*>(num);  
        Float* result = new Float(number->val() + this->val());
        delete num;
        delete this;
		return result;
	}
        ...
        //complex로 리턴
		Complex* number = dynamic_cast<Complex*>(num);  
        Complex* result = new Complex(number->real() + this->val(), number->imag());
        delete num;
        delete this;
        return result;
	}
...
Number *Integer::sub(Number * num) {
     ...
     */
      ...
      if(num->types() == INTEGER){
		Integer* number = dynamic_cast<Integer*>(num);
        set_val(this->val() - number->val());
		delete num;
		return this;		
	}
	else if(num->types() == FLOAT){
		Float* number = dynamic_cast<Float*>(num);  
        Float* result = new Float(this->val() - number->val());
        delete num;
        delete this;
		return result;
	}
        ...
        //complex로 리턴
		Complex* number = dynamic_cast<Complex*>(num);  
        Complex* result = new Complex(this->val() - number->real(), number->imag());
        delete num;
        delete this;
        return result;
	}
   ...
   if(num->types() == INTEGER){
	...
	Float* number = dynamic_cast<Float*>(num);  
		...
		return result;
         ...
         //complex로 리턴
		Complex* number = dynamic_cast<Complex*>(num);  
        Complex* result = new Complex(this->val() * number->real() - this->val() * number->imag(), this->val() * number->imag() + number->real());
        delete num;
        delete this;
        return result;
